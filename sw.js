const CACHE="held-v1.3";
const ASSETS=["./","./index.html","./styles.css","./polish.css","./app.js","./content.js","./polish.js","./content-polish.js","./manifest.webmanifest","./icons/apple-touch-icon.png","./icons/icon-192.png","./icons/icon-512.png"];
