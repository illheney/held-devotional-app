const CACHE="held-v1.7.0";
const ASSETS=["./","./index.html","./styles.css","./polish.css","./onboarding-fix.css","./journeys.css","./growth.css","./memories.css","./app.js","./content.js","./polish.js","./onboarding-fix.js","./scripture.js","./journeys.js","./journey-translation.js","./growth.js","./memory-sources.js","./memories-core.js","./memory-today.js","./memory-actions.js","./memory-journey.js","./memory-settings.js","./stability.js","./content-polish.js","./manifest.webmanifest","./icons/apple-touch-icon.png","./icons/icon-192.png","./icons/icon-512.png"];
